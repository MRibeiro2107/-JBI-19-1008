...
PR-OSA<-PD_ENSEMBLE(dados_state[[2]],c("center","scale"),0.9,0.1,models,12,1234)
...
PR-DSA<-PD_ENSEMBLE(dados_state[[2]],c("center","scale"),0.9,0.1,models,12,1234)
...
PR-TSA<-PD_ENSEMBLE(dados_state[[2]],c("center","scale"),0.9,0.1,models,12,1234)
